...
export let options = {
  stages: [
      // Ramp-up from 1 to TARGET_VUS virtual users (VUs) in 50s
      { duration: "50s", target: target_vus },

      // Stay at rest on TARGET_VUS VUs for 100s
      { duration: "100s", target: target_vus },

      // Ramp-down from TARGET_VUS to 0 VUs for 50s
